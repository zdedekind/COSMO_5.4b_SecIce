...
#if !defined __COSMO__ && !defined _OPENACC
#include "consistent_fma.inc"
#endif

MODULE conv_cuflxtends
...
!  USE yomhook   ,ONLY : lhook,   dr_hook
  !KF
  USE conv_cuparameters, ONLY: lphylin , rlptrc,  lepcld,             &
  ...
  USE conv_cufunctions, ONLY: foelhmcu, foeewmcu, foealfcu, &
    &                         foeewl,   foeewi
