...
!  USE yomhook   ,ONLY : lhook,   dr_hook
  ...
  USE conv_cuparameters, ONLY: r2es, r3les, r3ies, r4les, r4ies,   &
...
CONTAINS
  ...
  !>KF functions PHIHS and PHIMS are moved to conv_cuparameters to avoid circular
  !  dependenies
  !        *PHI AND *PSI FUNCTIONS FOR UNSTABLE SITUATIONS ACCORDING
