...
!  USE yomhook   ,ONLY: lhook,   dr_hook
  ...
  USE conv_cuparameters,  ONLY : rkap,  r4les, r4ies   ,&
    &                            r5les ,r5ies ,ralfdcp ,&
    &                            lphylin               ,&
    &                            lmfdudv,  rdepths     ,&
    &                            rcpd   ,retv, rd, rg  ,&
  ...
  USE conv_adjust ,ONLY: cuadjtq ,cuadjtqs
...
!
    ...
    USE conv_cufunctions, ONLY: foealfcu, foeewm, foealfa
