...
! >> 20170306_SS sylvia
! >> 20170726_SS sylvia, updated
! set ice multiplication parameters (weighting, rain_freeze, complete_ice_snow_riming)
! rim_typ (1)-ice_cloud; (2)-snow_cloud; (3)-graupel_cloud; (4)-hail_cloud
!         (5)-ice_rain;  (6)-snow_rain;  (7)-graupel_rain;  (8)-hail_rain
...
! wFuncCode
  ...
  CHARACTER(8), PARAMETER     :: rim_typ   = '11101110'       !..rime splintering occurs between which hydrometeors
  CHARACTER(5), PARAMETER     :: mult_typ  = '01011'          !..break up upon collision between which hydrometeors
  ...
  DOUBLE PRECISION, PARAMETER :: mu_DS     = 258              !..Durchschnitt [K]
  DOUBLE PRECISION, PARAMETER :: Nsh_DS    = 10               !..Splitternummer beim Gefrieren
  DOUBLE PRECISION, PARAMETER :: RS_mult   = 3.5d8            !..Koefficient fuer Rime-Splintering [kg rime -1]
  DOUBLE PRECISION, PARAMETER :: F_BR      = 180d0 !360d0 !280d0            !..Koefficient fuer Breakup
  DOUBLE PRECISION, PARAMETER :: T_min_BR  = 252d0 !249d0 !252d0            !..Minimumtemperatur fuer Breakup [K]
  DOUBLE PRECISION, PARAMETER :: gamma_BR  = 2.5d0 !5d0              !..Zerfallsrate fuer Splitternummer vom Breakup
  DOUBLE PRECISION, PARAMETER :: e_coll_I  = 1d0              !..Efficienz der Kollisionen zwischen Eishydrometeore
! << 20160726_SS sylvia, updated
! << 20170306_SS sylvia
...
!! SS_20180830, sylvia
  DOUBLE PRECISION, PARAMETER :: D_krit_RS = 25.00d-6 ! D-Schwellenwert fuer rime-splintering
!! SS_20180830, sylvia
...
!! << SS_20160525, sylvia
       ...
       & Ni_sec_gr_br_ice_d, Ni_sec_gr_br_snow_d, Ni_sec_dr_spl_d, Ni_sec_hm_d, Ni_pri_homhet_d, &
!! << ZD_20190819

!OCH >> 
!       & cmp_act_qc_d,   cmp_act_qnc_d,    cmp_fr_qi_d,      &
!       & cmp_fr_qni_d,   cmp_nuc_qi_d,     cmp_nuc_qni_d,    &
       & cmp_dep_qi_d,   cmp_dep_qs_d,    cmp_dep_qg_d, cmp_self_qi_d,&
!       & cmp_dep_qi_d,   cmp_dep_qc_d,     cmp_dep_qs_d,     &
       & cmp_sub_qi_d,   cmp_sub_qs_d, cmp_sub_qg_d,        &
       & cmp_self_qni_d,  cmp_rime_qi_qc_d, cmp_rime_qs_qc_d, cmp_rime_qg_qc_d,    &
       & cmp_rime_qi_qr_d, cmp_rime_qs_qr_d, cmp_rime_qg_qr_d, cmp_melt_qs_qr_d, cmp_melt_qi_qr_d,  &
       & cmp_self_qns_d,   cmp_self_qng_d, cmp_melt_snow_d, cmp_melt_ice_d, &
!       & cmp_self_qnc_d, cmp_rime_qi_qc_d, cmp_rime_qs_qc_d, &
       & cmp_rime_ice_d, cmp_rime_snow_d, cmp_rime_graup_d, cmp_coll_qi_qs_d, cmp_coll_qi_qg_d, cmp_conv_qc_qr_d, &
       & cmp_rime_ice_rain_d, cmp_rime_snow_rain_d, cmp_rime_graup_rain_d, &
!       &! cmp_coll_qi_qs_d, 
       & cmp_coll_qni_qns_d, cmp_coll_qni_qng_d, cmp_conv_qni_qng_d , &
!       & cmp_coll_qc_qr_d, cmp_coll_qnc_qnr_d,          &
       & cmp_conv_qi_qg_d ,cmp_conv_qs_qg_d, &
       & cmp_conv_qns_qng_d !, cmp_conv_qc_qr_d,               &
!       & cmp_conv_qnc_qnr_d, cmp_mult_ice_d, cmp_mult_snow_d,    &
!       & cmp_mult_graup_d, cmp_hom_sol_qi_d, cmp_hom_sol_qni_d,  &
!       & cmp_hom_qi_d, cmp_hom_qni_d
!OCH <<
...
Module globale_variablen
  USE wolken_driver, ONLY: dt, loc_ix, loc_iy, loc_iz, dim_ix, dim_iy, dim_iz, &
       ...
       & cmp_self_qni_d, cmp_rime_qi_qc_d, cmp_rime_qs_qc_d, cmp_rime_qg_qc_d,   &
       & cmp_rime_qi_qr_d, cmp_rime_qs_qr_d, cmp_rime_qg_qr_d, cmp_melt_qs_qr_d, cmp_melt_qi_qr_d, &
       & cmp_rime_ice_d, cmp_rime_snow_d, cmp_coll_qi_qs_d, cmp_coll_qi_qg_d, cmp_conv_qc_qr_d, &
       & cmp_rime_ice_rain_d, cmp_rime_snow_rain_d, cmp_rime_graup_rain_d, &
!       & cmp_act_qc_d,   cmp_act_qnc_d,    cmp_fr_qi_d,      &
!       & cmp_fr_qni_d,   cmp_nuc_qi_d,     cmp_nuc_qni_d,    &
!       & cmp_dep_qi_d,   cmp_dep_qc_d,     cmp_dep_qs_d,     &
...
!       & cmp_self_qnc_d, cmp_rime_qi_qc_d, cmp_rime_qs_qc_d, &
!       & cmp_rime_qg_qc_d, &
       & cmp_rime_graup_d,&! cmp_coll_qi_qs_d,  &
!       & cmp_coll_qc_qr_d, cmp_coll_qnc_qnr_d,  &
       & cmp_coll_qni_qns_d, cmp_coll_qni_qng_d, cmp_conv_qni_qng_d , &
       & cmp_conv_qi_qg_d, cmp_conv_qs_qg_d, &
       & cmp_conv_qns_qng_d, & !cmp_conv_qc_qr_d,               &
...
! >> SS_20170728, sylvia
            Ni_primary(i,j,k) = Ni_primary(i,j,k) + nuc_n
! << SS_20170728
            Ni_pri_homhet_d(i,j,k) = Ni_pri_homhet_d(i,j,k) + nuc_n  !ZD
...
! >> SS_20170728, sylvia
            Ni_primary(i,j,k) = Ni_primary(i,j,k) + nuc_n(i,j,k)
! << SS_20170728, sylvia
            Ni_pri_homhet_d(i,j,k) = Ni_pri_homhet_d(i,j,k) + nuc_n(i,j,k)  !ZD
...
!       IF(qcb < QSI)      qcb = QSI + 1e-20
  ...
  SUBROUTINE ice_nucleation_homhet()
    ...
    USE globale_variablen,  ONLY: loc_ix, loc_iy, loc_iz, dim_ix, dim_iy, dim_iz, T, p, q, &
         ...
         &                           dqdt,speichere_dqdt,                &
         &                           cond_neu_sb, evap_neu_sb, speichere_precipstat, &!, &
!         &                           cmp_nuc_qi_d, cmp_nuc_qni_d, cmp_hom_sol_qi_d, &
!         &                           cmp_hom_sol_qni_d, cmp_fr_qi_d, cmp_fr_qni_d

         &                           Ni_primary, Ni_pri_homhet_d !ZD
! >> SS_20170728, sylvia
    USE konstanten,         ONLY: pi,r,cv,cp,wolke_typ 
    USE parallele_umgebung, ONLY: isIO,abortparallel
    USE data_runcontrol,    ONLY: lcmprates
...
! >> SS_20170728, sylvia
                Ni_primary(i,j,k) = Ni_primary(i,j,k) + nuc_n_tmp
! << SS_20170728
                Ni_pri_homhet_d(i,j,k) = Ni_pri_homhet_d(i,j,k) + nuc_n_tmp  !ZD
                q_ice(i,j,k) = q_ice(i,j,k) + nuc_q_tmp
                q(i,j,k)     = q(i,j,k)     - nuc_q_tmp
! UB_20100420<<
!OCH>>
!                IF (lcmprates) THEN
!                  cmp_nuc_qi_d(i,j,k)   = nuc_q_tmp
!                  cmp_nuc_qni_d(i,j,k)  = nuc_n_tmp
!                END IF
!OCH<<
...
!OCH>>
!                IF (lcmprates) THEN
!                  cmp_hom_sol_qi_d(i,j,k)  = nuc_q_tmp
!                  cmp_hom_sol_qni_d(i,j,k) = nuc_n_tmp
!                END IF
!OCH<<
...
! >> SS_20170308, sylvia
! calculates the temperature weighting for rime splintering to occur
! weightCode is the integer code that indicates which function to use

DOUBLE PRECISION FUNCTION weighting(weightCode,temp)
   USE parallele_umgebung, ONLY: isIO

   IMPLICIT NONE
   INTEGER,          intent(in) :: weightCode
   DOUBLE PRECISION, intent(in) :: temp

   DOUBLE PRECISION :: T_mult_max,T_mult_min,T_mult_opt
   DOUBLE PRECISION :: mult_1,mult_2,const3,const4

   IF (isIO() .AND. isdebug) THEN
      IF (weightCode == 0) THEN
        WRITE (6, *) "RIME SPLINTERING with default weighting"
      ELSEIF (weightCode == 1) THEN
        WRITE (6, *) "RIME SPLINTERING with uniform weighting"
      ELSE
        WRITE (6, *) "Unspecified weighting code given for RIME SPLINTERING"
        WRITE (6, *) "Default weighting applied"
      ENDIF
    END IF

   IF (weightCode == 1) THEN ! uniform temperature weight
        T_mult_max = 273d0
        T_mult_min = 263d0

        ! this weighting is effectively a Heaviside function
        ! between 263 and 273 K
        IF (temp < T_mult_min) THEN
           mult_1 = 0d0
        ELSE
           mult_1 = 1d0
        ENDIF

        IF (temp > T_mult_max) THEN
           mult_2 = 0d0
        ELSE
           mult_2 = 1d0
        ENDIF
        weighting = mult_1*mult_2

   ELSE   ! default temperature weight for unspecified code or code of 0
        T_mult_max = 270d0
        T_mult_min = 265d0
        T_mult_opt = 268d0
        const3     = 1/(T_mult_opt - T_mult_min)
        const4     = 1/(T_mult_opt - T_mult_max)
        mult_1     = (temp - T_mult_min)*const3
        mult_2     = (temp - T_mult_max)*const4
        mult_1     = MAX(0.d0,MIN(mult_1,1.d0))
        mult_2     = MAX(0.d0,MIN(mult_2,1.d0))  !ZD added from original HM scheme
        weighting  = mult_1*mult_2
...
! << SS_20170308, sylvia
  ...
  SUBROUTINE ice_cloud_riming()
    ...
    USE globale_variablen,  ONLY: loc_ix, loc_iy, loc_iz, dim_ix, dim_iy, dim_iz, &
         ...
         &                        rimeqcrate_ice, rimencrate_ice, cmp_rime_qi_qc_d, cmp_rime_ice_d,  &
         &                        cmp_conv_qi_qg_d, cmp_conv_qni_qng_d, & !cmp_mult_ice_d
! >> SS_20170728, sylvia
        &                         Ni_secondary
! << SS_20170728
    ...
    USE parallele_umgebung, ONLY: isIO
    USE wolken_konstanten,   ONLY: wFuncCode, rim_typ    ! SS_20170306, sylvia
    USE data_runcontrol,    ONLY: lcmprates
    ...
    DOUBLE PRECISION            :: const1,const2,const5,mult_w !sylvia_20170306 const3,const4,,mult_1,mult_2
...
!                      write (*,*) '1Z. CLOUD ice_cloud_riming mit ice_multiplication' !ZD
...
! >> SS_20170306 sylvia, updated SS_20180830
              mult_q = 0.0
              IF (T_a < T_3 .AND. ice_multiplication .AND. rim_typ(1:1) .EQ. '1' .AND. D_c > D_krit_RS) THEN
!                      write (*,*) '2Z. rim(1:1)' !ZD
                mult_w = weighting(wFuncCode,T_a)
                mult_n = RS_mult * mult_w * rime_q
                n_ice(i,j,k)  = n_ice(i,j,k)  + mult_n

                Ni_secondary(i,j,k) = Ni_secondary(i,j,k) + mult_n
              ENDIF
! << SS_20170306 sylvia, updated SS_20180830
...
!>>OCH
              IF (lcmprates) THEN
                cmp_conv_qi_qg_d(i,j,k)   = conv_q
                cmp_conv_qni_qng_d(i,j,k) = conv_n
              END IF
!<<OCH
              ! ub>>
#ifdef SAVE_CONVERSIONRATES
...
!>>ZD
            IF (lcmprates) THEN
              cmp_rime_qi_qc_d(i,j,k) = rime_q
              cmp_rime_ice_d(i,j,k)   = rime_n
            END IF
!<<ZD
  ...
  SUBROUTINE snow_cloud_riming()
    ...
    USE globale_variablen,  ONLY: loc_ix, loc_iy, loc_iz, dim_ix, dim_iy, dim_iz, &
         ...
         &                        rimeqcrate_snow, rimencrate_snow, cmp_rime_qs_qc_d, &
         &                        cmp_rime_snow_d, cmp_conv_qs_qg_d, cmp_conv_qns_qng_d, &
!         &                        cmp_mult_snow_d
...
! << SS_20170728
    ...
    DOUBLE PRECISION            :: const1,mult_w,const5   ! SS_20170306, sylvia: const3,const4,mult_1,mult_2
...
!                      write (*,*) '3Z. CLOUD snow_cloud_riming mit ice_multiplication' !ZD
      ELSE
...
!>>OCH
!              IF (lcmprates) THEN
!                cmp_rime_qs_qc_d(i,j,k) = rime_q
!                cmp_rime_snow_d(i,j,k)  = rime_n
!              END IF
!<<OCH
              ! ub>>
#ifdef SAVE_CONVERSIONRATES
...
! >> SS_20170306 sylvia, updated SS_20180830
              mult_q = 0.0
              IF (T_a < T_3 .AND. ice_multiplication .AND. rim_typ(2:2) .EQ. '1' .AND. D_c > D_krit_RS) THEN
!                      write (*,*) '4Z. rim(2:2)' !ZD
                mult_w = weighting(wFuncCode,T_a)
                mult_n = RS_mult * mult_w * rime_q
...
!>>OCH
              IF (lcmprates) THEN
                cmp_conv_qs_qg_d(i,j,k)   = conv_q
                cmp_conv_qns_qng_d(i,j,k) = conv_n
              END IF
!<<OCH
              ! ub>>
#ifdef SAVE_CONVERSIONRATES
...
!<<ZD
  ...
  SUBROUTINE graupel_cloud_riming()
    ...
    USE globale_variablen,  ONLY: loc_ix, loc_iy, loc_iz, dim_ix, dim_iy, dim_iz, &
         ...
         &                        q_ice, n_ice, dt, dqdt, speichere_dqdt, cmp_rime_qg_qc_d, &
         &                        cmp_rime_graup_d,&! cmp_mult_graup_d

! >> SS_20170728, sylvia
         &                        Ni_secondary, Ni_sec_hm_d
! << SS_20170728
    ...
    DOUBLE PRECISION            :: const1,mult_w,const4        ! sylvia const2,const3,,mult_1,mult_2
...
!                      write (*,*) '5Z. CLOUD graupel_cloud_riming mit ice_multiplication' !ZD
...
!>>ZD
            IF (lcmprates) THEN
              cmp_rime_qg_qc_d(i,j,k) = rime_q
              cmp_rime_graup_d(i,j,k) = rime_n
            END IF
!<<ZD
...
! SS_20170306 sylvia, updated SS_20180830
            mult_q = 0.0
            mult_n = 0.0   !ZD
            IF (T_a < T_3 .AND. ice_multiplication .AND. rim_typ(3:3) .eq. '1' .AND. D_c > D_krit_RS) THEN
!                      write (*,*) '6Z. rim(3:3)' !ZD
              mult_w = weighting(wFuncCode,T_a)
              mult_n = RS_mult * mult_w * rime_q
              mult_q = mult_n * ice%x_min
              ...
              Ni_secondary(i,j,k) = Ni_secondary(i,j,k) + mult_n
              Ni_sec_hm_d(i,j,k) = Ni_sec_hm_d(i,j,k) + mult_n
            ENDIF
! SS_20170306 sylvia, updated SS_20180830
!>>OCH
!            IF (lcmprates) THEN
!              cmp_mult_graup_d(i,j,k) = mult_n
!            END IF
!<<OCH
...
! << SS_20170728
    ...
    DOUBLE PRECISION            :: const1,const4,mult_w    ! sylvia const2,const3,,mult_1,mult_2
...
!                      write (*,*) '7Z. CLOUD hail_cloud_riming mit ice_multiplication' !ZD
      ELSEIF (enhanced_melting .AND. .NOT. ice_multiplication) THEN
...
! >> SS_20170306 sylvia, updated SS_20180830
            mult_q = 0.0
            IF (T_a < T_3 .AND. ice_multiplication .AND. rim_typ(4:4) .eq. '1' .AND. D_c > D_krit_RS) THEN
!                      write (*,*) '8Z. rim(4:4)' !ZD
              mult_w = weighting(wFuncCode,T_a)
              mult_n = RS_mult * mult_w * rime_q
              mult_q = mult_n * ice%x_min
...
! >> SS_20170306 sylvia, updated SS_20180830
  ...
  SUBROUTINE ice_rain_riming()
    ...
    USE globale_variablen,  ONLY: loc_ix, loc_iy, loc_iz, dim_ix, dim_iy, dim_iz, &
         ...
         &                        d_id_sp, d_rd_sp_ice, cmp_rime_qi_qr_d, cmp_rime_ice_rain_d, &
! >> SS_20170728, sylvia
         &                        Ni_secondary
! << SS_20170728
    ...
    DOUBLE PRECISION            :: mult_w   ! >> SS_2017037, sylvia: const3,const4,,mult_1,mult_2
...
!                      write (*,*) '9Z. CLOUD ice_rain_riming mit ice_multiplication' !ZD
      ELSE
  ...
  ! >> SS_20170307, sylvia
  !  const3 = 1/(T_mult_opt_ir - T_mult_min_ir)
  !  const4 = 1/(T_mult_opt_ir - T_mult_max_ir) ! sylvia T_mult_* -->
  !  T_mult_*_ir
  ! << SS_20170307, sylvia
   DO k = 1, loc_iz
      DO j = 1, loc_iy
...
! >> SS_20170307 sylvia
              ! Verwendung der neuen Temperaturkriterien für Eismultiplikation
              ! zwishcen Eiskristallen und Regentropfen
              IF (T_a < T_3 .AND. ice_multiplication .AND. rim_typ(5:5) .eq. '1') THEN
!                      write (*,*) '10Z. rim(5:5)' !ZD
                mult_w = weighting(wFuncCode,T_a)
                mult_n = RS_mult * mult_w * rime_qr
                mult_q = mult_n * ice%x_min
...
! >> SS_20170728, sylvia, update Ni_secondary
               Ni_secondary(i,j,k) = Ni_secondary(i,j,k) + mult_n
! << SS_20170728, sylvia
...
!>>ZD
          IF (lcmprates) THEN
            cmp_rime_qi_qr_d(i,j,k) = rime_qr
            cmp_rime_ice_rain_d(i,j,k)   = rime_n
          END IF
!ZD<<
  ...
  SUBROUTINE snow_rain_riming()
    ...
    USE globale_variablen,  ONLY: loc_ix, loc_iy, loc_iz, dim_ix, dim_iy, dim_iz, &
         ...
         &                        d_sd_sp, d_rd_sp_snow, cmp_rime_qs_qr_d, cmp_rime_snow_rain_d,&
! >> SS_20170728, sylvia
         &                         Ni_secondary
! << SS_20170728
    ...
    USE konstanten,         ONLY: pi,cv,cp,wolke_typ 
    USE parallele_umgebung, ONLY: isIO
    USE wolken_konstanten,   ONLY: rim_typ,wFuncCode   ! >> SS_20170307, sylvia
    USE data_runcontrol,    ONLY: lcmprates
...
!                      write (*,*) '11Z. CLOUD snow_rain_riming mit ice_multiplication' !ZD
      ELSE
...
! SS_20170307 >> sylvia
              ! Entfernung der Eismultiplikation zwischen Schnee und Regentropfen
              mult_q = 0.0
              mult_n = 0.0 ! UB_20081120
              IF (T_a < T_3 .AND. ice_multiplication .and. rim_typ(6:6) .eq. '1') THEN
!                      write (*,*) '12Z. rim(6:6)' !ZD
                mult_w = weighting(wFuncCode,T_a)
                mult_n = RS_mult * mult_w * rime_qr
                mult_q = mult_n * ice%x_min
                mult_q = MIN(rime_qr,mult_q)
...
!>>ZD
              IF (lcmprates) THEN
                cmp_rime_qs_qr_d(i,j,k) = rime_qr
                cmp_rime_snow_rain_d(i,j,k)   = rime_n
              END IF
!<<ZD
  ...
  SUBROUTINE graupel_rain_riming()
    ...
    USE globale_variablen,  ONLY: loc_ix, loc_iy, loc_iz, dim_ix, dim_iy, dim_iz, &
         ...
         &                        q_ice, n_ice, dt, dqdt, speichere_dqdt, cmp_rime_qg_qr_d, cmp_rime_graup_rain_d,  &
! >> SS_20170728, sylvia
         &                        Ni_secondary, Ni_sec_hm_d
! << SS_20170728
    ...
    DOUBLE PRECISION            :: mult_w   ! >> SS_20170307, sylvia: const3,const4,,mult_1,mult_2
...
!                      write (*,*) '13Z. CLOUD graupel_rain_riming mit ice_multiplication' !ZD
      ELSEIF (enhanced_melting .AND. .NOT. ice_multiplication) THEN
...
!>>ZD
              IF (lcmprates) THEN
               cmp_rime_qg_qr_d(i,j,k) = rime_q
               cmp_rime_graup_rain_d(i,j,k) = rime_n
              END IF
!<<ZD
...
! >> SS_20170307, sylvia
              mult_q = 0.0
              mult_n = 0.0   !ZD
              IF (T_a < T_3 .AND. ice_multiplication .AND. rim_typ(7:7) .eq. '1') THEN
!                      write (*,*) '14Z. rim(7:7)' !ZD
                mult_w = weighting(wFuncCode,T_a)
                mult_n = RS_mult * mult_w * rime_q
                mult_q = mult_n * ice%x_min
                mult_q = MIN(rime_q,mult_q)
    ...
    IF (isIO() .AND. isdebug) THEN
      IF (enhanced_melting .AND. ice_multiplication) THEN
        WRITE (6, *) "CLOUD hail_rain_riming mit ice_multiplication und enhanced_melting"
                      !write (*,*) '16Z. CLOUD hail_rain_riming mit ice_multiplication' !ZD
...
! >> SS_20170307, sylvia
            mult_q = 0.0
            IF (T_a < T_3 .AND. ice_multiplication .and. rim_typ(8:8) .eq. '1') THEN
                      !write (*,*) '17Z. rim(8:8)' !ZD
              mult_w = weighting(wFuncCode,T_a)
              mult_n = RS_mult * mult_w * rime_q
              mult_q = mult_n * ice%x_min
              mult_q = MIN(rime_q,mult_q)
...
! << SS_20170307, sylvia
  ...
  SUBROUTINE complete_ice_snow_riming ()
    ...
    DOUBLE PRECISION            :: conv_n,conv_q
    DOUBLE PRECISION            :: mult_n,mult_q
    DOUBLE PRECISION            :: const2,const5
    DOUBLE PRECISION            :: mult_w    ! >> SS_20170307, sylvia: const3,const4,mult_1,mult_2
    DOUBLE PRECISION, SAVE      :: D_av_fakt_i,D_av_fakt_s
! >> SS_20180907, sylvia
    DOUBLE PRECISION            :: D_c,x_c,q_c,n_c
! << SS_20180907, sylvia
    ...
    IF(isIO() .AND. isdebug)THEN
      IF (ice_multiplication) THEN
        WRITE (6, *) "CLOUD complete_ice_snow_riming mit ice_multiplication"
                      !write (*,*) '19Z. CLOUD complete_ice_snow_riming mit ice_multiplication' !ZD
...
! >> SS_20170307, sylvia
    IF (rim_typ(1:1) .eq. '1') THEN
      WRITE (6, *) "ice_cloud_riming active"
    ENDIF
    IF (rim_typ(2:2) .eq. '1') THEN
      WRITE (6, *) "snow_cloud_riming active"
    ENDIF
    IF (rim_typ(5:5) .eq. '1') THEN
      WRITE (6, *) "ice_rain_riming active"
    ENDIF
    IF (rim_typ(6:6) .eq. '1') THEN
      WRITE (6, *) "snow_rain_riming active"
    ENDIF
! << SS_20170307, sylvia
...
! << SS_20170307, sylvia
   ...
   ! >> SS_20170307, sylvia, updated SS_20180830
              n_c = n_cloud(i,j,k)           !..Anzahldichte
              q_c = q_cloud(i,j,k)           !..Fluessigwassergehalt
              x_c = MIN(MAX(q_c/(n_c+eps),cloud%x_min),cloud%x_max)          !..mittlere Masse
              D_c = cloud%a_geo * x_c**cloud%b_geo              !..mittlerer Durchmesser
              IF (T_a < T_3 .AND. ice_multiplication .AND. rim_typ(1:1) .eq. '1' .AND. D_c > D_krit_RS) THEN
                     ! write (*,*) '20Z. rim(1:1)' !ZD
                mult_w = weighting(wFuncCode,T_a)
                mult_n = RS_mult * mult_w * rime_q
                n_ice(i,j,k) = n_ice(i,j,k)  + mult_n
...
! >> SS_20170307, sylvia, updated SS_20180907
              n_c = n_cloud(i,j,k)           !..Anzahldichte
              q_c = q_cloud(i,j,k)           !..Fluessigwassergehalt
              x_c = MIN(MAX(q_c/(n_c+eps),cloud%x_min),cloud%x_max)      !..mittlere Masse
              D_c = cloud%a_geo * x_c**cloud%b_geo            !..mittlerer Durchmesser
              IF (T_a < T_3 .AND. ice_multiplication .AND. rim_typ(1:1) .eq. '1'  .AND. D_c > D_krit_RS) THEN
                      !write (*,*) '22Z. rim(1:1)' !ZD
...
! >> SS_20170307, sylvia, updated SS_20180907
              ...
              IF (T_a < T_3 .AND. ice_multiplication .AND. rim_typ(2:2) .eq. '1') THEN
                      !write (*,*) '24Z. rim(2:2)' !ZD
                mult_w = weighting(wFuncCode,T_a)
                mult_n = RS_mult * mult_w * rime_q
                mult_q = mult_n * ice%x_min
                mult_q = MIN(rime_q,mult_q)
...
!         &                        cmp_rime_qi_qc_d, cmp_mult_ice_d, &
!         &                        cmp_mult_graup_d, cmp_melt_ice_d, cmp_melt_qi_d, &
         &                        cmp_rime_qg_qr_d, &! cmp_rime_qng_qnr_d, cmp_rime_qi_qr_d, &
!         &                        cmp_rime_qs_qc_d, cmp_mult_ice_snow_d, cmp_rime_qs_qr_d, &

         &                        cmp_conv_qs_qg_d, cmp_conv_qns_qng_d,& ! cmp_rime_qr_qs_qg_d,&
!         &                        !cmp_rime_qnr_qns_qng_d
         &                        cmp_rime_qi_qc_d,cmp_rime_qi_qr_d,cmp_rime_qs_qc_d,cmp_rime_qs_qr_d, &
         &                        cmp_melt_qi_qr_d,cmp_melt_qs_qr_d, cmp_melt_snow_d, cmp_melt_ice_d, &
! >> SS_20170728, sylvia
         &                        Ni_secondary, Ni_sec_hm_d
! << SS_20170728
    ...
    DOUBLE PRECISION            :: conv_n,conv_q
    DOUBLE PRECISION            :: mult_n,mult_q
    DOUBLE PRECISION            :: const2,const5,mult_w   ! >> SS_20170307, sylvia: const4,const3,mult_1,mult_2
    DOUBLE PRECISION, SAVE      :: D_av_fakt_i,D_av_fakt_s
! >> SS_20180907, sylvia
    DOUBLE PRECISION            :: D_c,x_c,q_c,n_c
! << SS_20180907, sylvia
    ...
    IF(isIO() .AND. isdebug)THEN
      IF (ice_multiplication) THEN
        WRITE (6, *) "CLOUD complete_ice_snow_rim_vec mit ice_multiplication"
                      !write (*,*) '28Z. CLOUD complete_ice_snow_riming_vec mit ice_multiplication' !ZD
      ELSE
...
! >> SS_20170307, sylvia
    IF (rim_typ(1:1) .eq. '1') THEN
      WRITE (6, *) "ice_cloud riming active"
    ENDIF
    IF (rim_typ(2:2) .eq. '1') THEN
      WRITE (6, *) "snow_cloud riming active"
    ENDIF
    IF (rim_typ(5:5) .eq. '1') THEN
      WRITE (6, *) "ice_rain riming active"
    ENDIF
    IF (rim_typ(6:6) .eq. '1') THEN
      WRITE (6, *) "snow_rain riming active"
    ENDIF
! << SS_20170307, sylvia
...
!>>ZD remove this because it is called in rime_cloud_riming_rate
!>>OCH
!              IF (lcmprates) THEN
!                 cmp_rime_qi_qc_d(i,j,k) = rime_q
!                 cmp_rime_ice_cloud_d(i,j,k)   = rime_n
!              END IF
!<<OCH
!<<ZD
...
! >> SS_20170307, sylvia, updated SS_20180907
              ...
              D_c = cloud%a_geo * x_c**cloud%b_geo
              IF (T_a < T_3 .AND. ice_multiplication .AND. rim_typ(1:1) .eq. '1' .AND. D_c > D_krit_RS) THEN
                      !write (*,*) '29Z. rim(1:1)'!ZD
                mult_w = weighting(wFuncCode,T_a)
                mult_n = RS_mult * mult_w * rime_q
                n_ice(i,j,k) = n_ice(i,j,k)  + mult_n
!>>OCH
!                IF (lcmprates) THEN
!                  cmp_mult_ice_d(i,j,k) = mult_n
!                END IF
!<<OCH
                Ni_secondary(i,j,k) = Ni_secondary(i,j,k) + mult_n
                Ni_sec_hm_d(i,j,k) = Ni_sec_hm_d(i,j,k) + mult_n !>>ZD 30.10.2019
              ENDIF
! << SS_20170307, sylvia, updated SS_20180907
...
! >> SS_20170307, sylvia
              ...
              mult_n = 0.0   !ZD
              IF (T_a < T_3 .AND. ice_multiplication .AND. rim_typ(5:5) .eq. '1') THEN
                      !write (*,*) '30Z. rim(5:5)'!ZD
                mult_w = weighting(wFuncCode,T_a)
                mult_n = RS_mult * mult_w * rime_q
                n_ice(i,j,k) = n_ice(i,j,k)  + mult_n
!>>OCH
!                IF (lcmprates) THEN
!                  cmp_mult_ice_d(i,j,k) =cmp_mult_ice_d(i,j,k)+ mult_n !was mult_ice_ set to 0?
!                END IF
!<<OCH
                Ni_secondary(i,j,k) = Ni_secondary(i,j,k) + mult_n
                Ni_sec_hm_d(i,j,k) = Ni_sec_hm_d(i,j,k) + mult_n !>>ZD 30.10.2019
...
!>>ZD remove this because it is called in ice_cloud_riming_rate
!>>OCH
!              IF (lcmprates) THEN
!                cmp_rime_qi_qc_d(i,j,k) = rime_q
!                cmp_rime_ice_cloud_d(i,j,k)   = rime_n
...
!>>OCH
                  IF (lcmprates) THEN
                     cmp_melt_ice_d(i,j,k) = rime_n !n_ice to rain , n_rain stays const => loss in ice #
                     cmp_melt_qi_qr_d(i,j,k) = rime_qr + rime_qi !ice to rain => los sin ice mass and gain in rain
                  END IF
!<<OCH
#ifdef SAVE_CONVERSIONRATES
                  IF (speichere_dqdt) THEN
...
!>>OCH
!                IF (lcmprates) THEN
!                   cmp_mult_ice_d(i,j,k) = cmp_mult_ice_d+mult_n
!                   cmp_mult_ice_snow_d(i,j,k) = mult_q
!                END IF
!<<OCH
...
!                IF (lcmprates) THEN
!                   cmp_mult_ice_d(i,j,k) =cmp_mult_ice_d(i,j,k)+ mult_n !was mult_ice_ set to 0?
  ! should work as dummies are set to 0, because sum is in interface
!                   cmp_mult_ice_snow_d(i,j,k) = cmp_mult_ice_snow_d+mult_q
!                END IF
!<<OCH
...
!>>OCH
                  IF (lcmprates) THEN
                     cmp_melt_snow_d(i,j,k) = rime_n !n_snow to rain , n_rain stays const => loss in snow #
                     cmp_melt_qs_qr_d(i,j,k) = rime_qr + rime_qs !ice to rain => los sin ice mass and gain in rain
                  END IF
!<<OCH
#ifdef SAVE_CONVERSIONRATES
                  IF (speichere_dqdt) THEN
...
!>>OCH
!                  IF (lcmprates) THEN
!                    cmp_rime_qr_qs_qg_d(i,j,k)   =rime_qr + rime_qs - mult_q
!                    cmp_rime_qnr_qns_qng_d(i,j,k) = rime_n
!                  END IF
!<<OCH
#ifdef SAVE_CONVERSIONRATES
                  IF (speichere_dqdt) THEN
...
! >> SS_20170317, sylvia
  SUBROUTINE hail_breakup_graupel

        !*******************************************************************************
        !                                                                              *
        !       Berechnung der Eisultiplikation nach mechanischer Kollisionen
        !       *
        !                                                                              *
        !*******************************************************************************

        USE globale_variablen, ONLY: loc_ix, loc_iy, loc_iz, dim_ix,   &
                 &                   dim_iy, dim_iz, T, p, q, q_ice,   &
                 &                   n_ice, q_graupel, n_graupel,  &
                 &                   n_hail, q_hail, dt, Ni_secondary
        ...
        DOUBLE PRECISION         :: mult_n,mult_1,mult_2
! sylvia: SAVEs ensure that deltas / thetas are not recalculated each time
        DOUBLE PRECISION, SAVE   :: delta_n_gg,delta_n_gh,delta_n_hh
        DOUBLE PRECISION, SAVE   :: delta_q_gg,delta_q_gh,delta_q_hh
        DOUBLE PRECISION, SAVE   :: theta_n_gg,theta_n_gh,theta_n_hh
        DOUBLE PRECISION, SAVE   :: theta_q_gg,theta_q_gh,theta_q_hh

        DOUBLE PRECISION, PARAMETER :: eps  = 1.d-20

        IF (isIO() .AND. isdebug) THEN
           WRITE (6, *) "CLOUD hail_breakup_graupel"
        END IF

        IF (firstcall .NE. 1) THEN
           delta_n_gg = coll_delta_11(graupel,hail,0)
           delta_n_gh = coll_delta_12(graupel,hail,0)
           delta_n_hh = coll_delta_22(graupel,hail,0)
           delta_q_gg = coll_delta_11(graupel,hail,1)
           delta_q_gh = coll_delta_12(graupel,hail,1)
           delta_q_hh = coll_delta_22(graupel,hail,1)

           theta_n_gg = coll_theta_11(graupel,hail,0)
           theta_n_gh = coll_theta_12(graupel,hail,0)
           theta_n_hh = coll_theta_22(graupel,hail,0)
           theta_q_gg = coll_theta_11(graupel,hail,1)
           theta_q_gh = coll_theta_12(graupel,hail,1)
           theta_q_hh = coll_theta_22(graupel,hail,1)
        ...
        IF (isIO() .AND. isdebug) THEN
           ...
           WRITE (6,'(A,D10.3)') "  Koeff. fuer Sedi. von Graupel:       alf_graupel  = ",graupel%a_vel
           WRITE (6,'(A,D10.3)') "                                       bet_graupel  = ",graupel%b_vel
           WRITE (6,'(A,D10.3)') "  Koeff. fuer coll Hagel-Graupel:      delta_n_gh = ",delta_n_gh
           WRITE (6,'(A,D10.3)') "                                       delta_n_gg = ",delta_n_gg
           WRITE (6,'(A,D10.3)') "                                       theta_n_hh = ",theta_n_hh
           WRITE (6,'(A,D10.3)') "                                       theta_n_gh = ",theta_n_gh
           WRITE (6,'(A,D10.3)') "                                       theta_n_gg = ",theta_n_gg
           WRITE (6,'(A,D10.3)') "                                       delta_q_hh = ",delta_q_hh
           WRITE (6,'(A,D10.3)') "                                       delta_q_gh = ",delta_q_gh
           WRITE (6,'(A,D10.3)') "                                       delta_q_gg = ",delta_q_gg
           WRITE (6,'(A,D10.3)') "                                       theta_q_hh = ",theta_q_hh
           WRITE (6,'(A,D10.3)') "                                       theta_q_gh = ",theta_q_gh
           WRITE (6,'(A,D10.3)') "                                       theta_q_gg = ",theta_q_gg
        END IF
        firstcall = 1
        ENDIF
...
!ZD_20190830 Change T_a > T_3
                   IF (T_a < T_3 .AND. q_h > q_krit .AND. q_g > q_krit) THEN
                      ...
                      D_h = hail%a_geo * x_h**hail%b_geo       !..mittlerer Durchmesser
                      v_h = hail%a_vel * x_h**hail%b_vel * &
                            rrho_04(i,j,k)**(rhovelha+rhovelhb*MIN(D_h,rhovelhdknick))
                                                          !..mittlere
                                                          !Sedimentationsgeschwingkeit

                      D_g = graupel%a_geo * x_g**graupel%b_geo  !..mittlerer Durchmesser
                      v_g = graupel%a_vel * x_g**graupel%b_vel * &
                            rrho_04(i,j,k)**(rhovelga+rhovelgb*MIN(D_g,rhovelgdknick))
                                                          !..mittlere
                                                          !Sedimentationsgeschwingkeit

                      coll_n = pi/4.0 * n_g * n_h * e_coll_I * dt  &
                      &        * (delta_n_gg * D_g**2 + delta_n_gh * D_g*D_h + delta_n_hh * D_h**2) &
                      &        * (theta_n_gg * v_g**2 - theta_n_gh * v_g*v_h + theta_n_hh * v_h**2)**0.5

                      coll_q = pi/4.0 * q_g * n_h * e_coll_I * dt  &
                      &        * (delta_q_gg * D_g**2 + delta_q_gh * D_g*D_h + delta_q_hh * D_h**2) &
                      &        * (theta_q_gg * v_g**2 - theta_q_gh * v_g*v_h + theta_q_hh * v_h**2)**0.5

!ZD_20190830 coll_q replace by coll_n
                      coll_n = MIN(n_g,coll_n) !ZD added from ice particles collecting one another routines
                      coll_q = MIN(q_g,coll_q) !ZD

                      mult_n = N_eject(T_a) * coll_n

                      n_graupel(i,j,k) = n_graupel(i,j,k) - coll_n
                      n_ice(i,j,k)     = n_ice(i,j,k)     + mult_n
...
! << SS_20170728, sylvia
        ...
        END SUBROUTINE hail_breakup_graupel
! >> SS_20170317, sylvia

! >> SS_20160602, sylvia, determine the number of ice fragments ejected upon
! >> SS_20170726, sylvia, updated to agree with the function in the SIM parcel
! model
        ! collision of ice hydrometeors, function based on Takahashi et al. 1995
        DOUBLE PRECISION FUNCTION N_eject(T)
           IMPLICIT NONE
           DOUBLE PRECISION, INTENT(in) :: T
...
! >> SS_20170317, sylvia
      SUBROUTINE graupel_breakup_ice

        !*******************************************************************************
        !                                                                              *
        !       Berechnung der Eismultiplikation nach mechanischer Kollisionen
        !       *
        !                                                                              *
        !*******************************************************************************
...
!! << ZD_20190819
        ...
        INTEGER                  :: i, j, k
        INTEGER, save            :: firstcall
        DOUBLE PRECISION         :: T_a,D_h
        DOUBLE PRECISION         :: q_i,n_i,x_i,d_i,v_i
        DOUBLE PRECISION         :: q_g,n_g,x_g,d_g,v_g
        DOUBLE PRECISION         :: coll_n,coll_q,e_coll
        DOUBLE PRECISION         :: mult_n,mult_1,mult_2
! sylvia: SAVEs ensure that deltas / thetas are not recalculated each time
        DOUBLE PRECISION, SAVE   :: delta_n_ii,delta_n_ig,delta_n_gg
        DOUBLE PRECISION, SAVE   :: delta_q_ii,delta_q_ig,delta_q_gg
        DOUBLE PRECISION, SAVE   :: theta_n_ii,theta_n_ig,theta_n_gg
        DOUBLE PRECISION, SAVE   :: theta_q_ii,theta_q_ig,theta_q_gg
        DOUBLE PRECISION, PARAMETER :: eps  = 1.d-20

        IF (isIO() .AND. isdebug) THEN
           WRITE (6, *) "CLOUD graupel_breakup_ice"
        END IF

        IF (firstcall .NE. 1) THEN
           delta_n_ii = coll_delta_11(ice,graupel,0)
           delta_n_ig = coll_delta_12(ice,graupel,0)
           delta_n_gg = coll_delta_22(ice,graupel,0)
           delta_q_ii = coll_delta_11(ice,graupel,1)
           delta_q_ig = coll_delta_12(ice,graupel,1)
           delta_q_gg = coll_delta_22(ice,graupel,1)

           theta_n_ii = coll_theta_11(ice,graupel,0)
           theta_n_ig = coll_theta_12(ice,graupel,0)
           theta_n_gg = coll_theta_22(ice,graupel,0)
           theta_q_ii = coll_theta_11(ice,graupel,1)
           theta_q_ig = coll_theta_12(ice,graupel,1)
           theta_q_gg = coll_theta_22(ice,graupel,1)
        ...
        IF (isIO() .AND. isdebug) THEN
           ...
           WRITE (6,'(A,D10.3)') "  Koeff. fuer Sedi. von Eis:           alf_ice     = ",ice%a_vel
           WRITE (6,'(A,D10.3)') "                                       bet_ice     = ",ice%b_vel
           WRITE (6,'(A,D10.3)') "  Koeff. fuer coll Graupel-Eis:      delta_n_ig    = ",delta_n_ig
           WRITE (6,'(A,D10.3)') "                                     delta_n_ii    = ",delta_n_ii
           WRITE (6,'(A,D10.3)') "                                     theta_n_gg    = ",theta_n_gg
           WRITE (6,'(A,D10.3)') "                                     theta_n_ig    = ",theta_n_ig
           WRITE (6,'(A,D10.3)') "                                     theta_n_ii    = ",theta_n_ii
           WRITE (6,'(A,D10.3)') "                                     delta_q_gg    = ",delta_q_gg
           WRITE (6,'(A,D10.3)') "                                     delta_q_ig    = ",delta_q_ig
           WRITE (6,'(A,D10.3)') "                                     delta_q_ii    = ",delta_q_ii
           WRITE (6,'(A,D10.3)') "                                     theta_q_gg    = ",theta_q_gg
           WRITE (6,'(A,D10.3)') "                                     theta_q_ig    = ",theta_q_ig
           WRITE (6,'(A,D10.3)') "                                     theta_q_ii    = ",theta_q_ii
        END IF
        firstcall = 1
        ENDIF
...
!ZD_20190830 Change T_a > T_3    IF (T_a > T_3 .AND. q_i > q_krit .AND. q_g > q_krit) THEN
                   IF (T_a < T_3 .AND. q_i > q_krit .AND. q_g > q_krit) THEN
                      !write (*,*) 'ZANE INTO GRAUPEL BREAK ICE ROUTINE', T_a, T_3 !ZD
                      n_i = n_ice(i,j,k)                !..Anzahldichte
                      n_g = n_graupel(i,j,k)             !..Anzahldichte
                      ...
                      D_i = ice%a_geo * x_i**ice%b_geo       !..mittlerer Durchmesser
                      v_i = ice%a_vel * x_i**ice%b_vel * &
                            rrho_04(i,j,k)**(rhovelia+rhovelib*MIN(D_i,rhovelidknick))
                                                          !..mittlere
                                                          !Sedimentationsgeschwingkeit
                      ...
                      coll_n = pi/4.0 * n_i * n_g * e_coll_I * dt  &
                      &        * (delta_n_ii * D_i**2 + delta_n_ig * D_i*D_g + delta_n_gg * D_g**2) &
                      &        * (theta_n_ii * v_i**2 - theta_n_ig * v_i*v_g + theta_n_gg * v_g**2)**0.5

                      coll_q = pi/4.0 * q_i * n_g * e_coll_I * dt  &
                      &        * (delta_q_ii * D_i**2 + delta_q_ig * D_i*D_g + delta_q_gg * D_g**2) &
                      &        * (theta_q_ii * v_i**2 - theta_q_ig * v_i*v_g + theta_q_gg * v_g**2)**0.5

!ZD_20190830 coll_q replace by coll_n
                      coll_n = MIN(n_i,coll_n) !ZD added from ice particles collecting one another routines

                      mult_n = N_eject(T_a) * coll_n

                      n_ice(i,j,k) = n_ice(i,j,k) + mult_n - coll_n

                      ! sylvia: in this case, there is no change in the ice
                      ! mixing ratio
                      ...
                      Ni_sec_gr_br_ice_d(i,j,k) = Ni_sec_gr_br_ice_d(i,j,k) + mult_n
                      !! << ZD_20190819
           ...
           END DO
        END DO
     END SUBROUTINE graupel_breakup_ice

! >> SS_20170317, sylvia

! >> SS_20170317, sylvia
      SUBROUTINE hail_breakup_ice
        ...
        DOUBLE PRECISION         :: q_i,n_i,x_i,d_i,v_i
        DOUBLE PRECISION         :: coll_n,coll_q,e_coll
        DOUBLE PRECISION         :: mult_n,mult_1,mult_2,mult_q
! sylvia: SAVEs ensure that deltas / thetas are not recalculated each time
        DOUBLE PRECISION, SAVE   :: delta_n_ii,delta_n_ih,delta_n_hh
        DOUBLE PRECISION, SAVE   :: delta_q_ii,delta_q_ih,delta_q_hh
        DOUBLE PRECISION, SAVE   :: theta_n_ii,theta_n_ih,theta_n_hh
        DOUBLE PRECISION, SAVE   :: theta_q_ii,theta_q_ih,theta_q_hh

        DOUBLE PRECISION, PARAMETER :: eps  = 1.d-20

        IF (isIO() .AND. isdebug) THEN
           WRITE (6, *) "CLOUD hail_breakup_ice"
        END IF

        IF (firstcall .NE. 1) THEN
           delta_n_ii = coll_delta_11(ice,hail,0)
           delta_n_ih = coll_delta_12(ice,hail,0)
           delta_n_hh = coll_delta_22(ice,hail,0)
           delta_q_ii = coll_delta_11(ice,hail,1)
           delta_q_ih = coll_delta_12(ice,hail,1)
           delta_q_hh = coll_delta_22(ice,hail,1)

           theta_n_ii = coll_theta_11(ice,hail,0)
           theta_n_ih = coll_theta_12(ice,hail,0)
           theta_n_hh = coll_theta_22(ice,hail,0)
           theta_q_ii = coll_theta_11(ice,hail,1)
           theta_q_ih = coll_theta_12(ice,hail,1)
           theta_q_hh = coll_theta_22(ice,hail,1)
        ...
        IF (isIO() .AND. isdebug) THEN
           ...
           WRITE (6,'(A,D10.3)') "  Koeff. fuer Sedi. von Eis:         alf_ice  = ",ice%a_vel
           WRITE (6,'(A,D10.3)') "                                     bet_ice  = ",ice%b_vel
           WRITE (6,'(A,D10.3)') "  Koeff. fuer coll Hagel-Eis:      delta_n_ih = ",delta_n_ih
           WRITE (6,'(A,D10.3)') "                                   delta_n_ii = ",delta_n_ii
           WRITE (6,'(A,D10.3)') "                                   theta_n_hh = ",theta_n_hh
           WRITE (6,'(A,D10.3)') "                                   theta_n_ih = ",theta_n_ih
           WRITE (6,'(A,D10.3)') "                                   theta_n_ii = ",theta_n_ii
           WRITE (6,'(A,D10.3)') "                                   delta_q_hh = ",delta_q_hh
           WRITE (6,'(A,D10.3)') "                                   delta_q_ih = ",delta_q_ih
           WRITE (6,'(A,D10.3)') "                                   delta_q_ii = ",delta_q_ii
           WRITE (6,'(A,D10.3)') "                                   theta_q_hh = ",theta_q_hh
           WRITE (6,'(A,D10.3)') "                                   theta_q_ih = ",theta_q_ih
           WRITE (6,'(A,D10.3)') "                                   theta_q_ii = ",theta_q_ii
        END IF
        firstcall = 1
        ENDIF
...
!ZD_20190830 Change T_a > T_3
                   IF (T_a < T_3 .AND. q_h > q_krit .AND. q_i > q_krit) THEN
                      ...
                      coll_n = pi/4.0 * n_i * n_h * e_coll_I * dt  &
                      &        * (delta_n_ii * D_i**2 + delta_n_ih * D_i*D_h + delta_n_hh * D_h**2) &
                      &        * (theta_n_ii * v_i**2 - theta_n_ih * v_i*v_h + theta_n_hh * v_h**2)**0.5

                      coll_q = pi/4.0 * q_i * n_h * e_coll_I * dt  &
                      &        * (delta_q_ii * D_i**2 + delta_q_ih * D_i*D_h + delta_q_hh * D_h**2) &
                      &        * (theta_q_ii * v_i**2 - theta_q_ih * v_i*v_h + theta_q_hh * v_h**2)**0.5
...
! << SS_20170728, sylvia
        ...
        END SUBROUTINE hail_breakup_ice
! >> SS_20170317, sylvia

! >> SS_20170317, sylvia
       SUBROUTINE graupel_breakup_snow
        ...
        USE globale_variablen, ONLY: loc_ix, loc_iy, loc_iz, dim_ix,   &
                 &                   dim_iy, dim_iz, T, p, q, q_snow,   &
                 &                   n_snow, q_graupel, n_graupel, dt,  &
                 &                   Ni_sec_gr_br_snow_d, &
!! << ZD_20190819
                 &                   Ni_secondary, n_ice, q_ice
        ...
        DOUBLE PRECISION         :: mult_n,mult_1,mult_2,mult_q
! sylvia: SAVEs ensure that deltas / thetas are not recalculated each time
        DOUBLE PRECISION, SAVE   :: delta_n_gg,delta_n_sg,delta_n_ss
        DOUBLE PRECISION, SAVE   :: delta_q_gg,delta_q_sg,delta_q_ss
        DOUBLE PRECISION, SAVE   :: theta_n_gg,theta_n_sg,theta_n_ss
        DOUBLE PRECISION, SAVE   :: theta_q_gg,theta_q_sg,theta_q_ss

        DOUBLE PRECISION, PARAMETER :: eps  = 1.d-20

        IF (isIO() .AND. isdebug) THEN
           WRITE (6, *) "CLOUD graupel_breakup_snow"
        END IF

        IF (firstcall .NE. 1) THEN
           delta_n_ss = coll_delta_11(snow,graupel,0)
           delta_n_sg = coll_delta_12(snow,graupel,0)
           delta_n_gg = coll_delta_22(snow,graupel,0)
           delta_q_ss = coll_delta_11(snow,graupel,1)
           delta_q_sg = coll_delta_12(snow,graupel,1)
           delta_q_gg = coll_delta_22(snow,graupel,1)

           theta_n_ss = coll_theta_11(snow,graupel,0)
           theta_n_sg = coll_theta_12(snow,graupel,0)
           theta_n_gg = coll_theta_22(snow,graupel,0)
           theta_q_ss = coll_theta_11(snow,graupel,1)
           theta_q_sg = coll_theta_12(snow,graupel,1)
           theta_q_gg = coll_theta_22(snow,graupel,1)
        ...
        IF (isIO() .AND. isdebug) THEN
           ...
           WRITE (6,'(A,D10.3)') "                                     bet_snow      = ",snow%b_vel
           WRITE (6,'(A,D10.3)') "  Koeff. fuer coll Graupel-Schnee:   delta_n_sg    = ",delta_n_sg
           WRITE (6,'(A,D10.3)') "                                     delta_n_ss    = ",delta_n_ss
           WRITE (6,'(A,D10.3)') "                                     theta_n_gg    = ",theta_n_gg
           WRITE (6,'(A,D10.3)') "                                     theta_n_sg    = ",theta_n_sg
           WRITE (6,'(A,D10.3)') "                                     theta_n_ss    = ",theta_n_ss
           WRITE (6,'(A,D10.3)') "                                     delta_q_gg    = ",delta_q_gg
           WRITE (6,'(A,D10.3)') "                                     delta_q_sg    = ",delta_q_sg
           WRITE (6,'(A,D10.3)') "                                     delta_q_ss    = ",delta_q_ss
           WRITE (6,'(A,D10.3)') "                                     theta_q_gg    = ",theta_q_gg
           WRITE (6,'(A,D10.3)') "                                     theta_q_sg    = ",theta_q_sg
           WRITE (6,'(A,D10.3)') "                                     theta_q_ss    = ",theta_q_ss
        END IF
        firstcall = 1
        ENDIF
...
!ZD_20190830 Change T_a > T_3   IF (T_a > T_3 .AND. q_s > q_krit .AND. q_g > q_krit) THEN
                   IF (T_a < T_3 .AND. q_s > q_krit .AND. q_g > q_krit) THEN
                      !write (*,*) 'ZANE INTO GRAUPEL BREAK SNOW ROUTINE',T_a ,T_3 !ZD

                      n_g = n_graupel(i,j,k)             !..Anzahldichte
                      n_s = n_snow(i,j,k)        ! ZD Added
                      ...
                      D_s = snow%a_geo * x_s**snow%b_geo       !..mittlerer Durchmesser
                      v_s = snow%a_vel * x_s**snow%b_vel * &
                            rrho_04(i,j,k)**(rhovelsa+rhovelsb*MIN(D_s,rhovelsdknick))
                                                          !..mittlere
                                                          !Sedimentationsgeschwingkeit
                      ...
                      coll_n = pi/4.0 * n_s * n_g * e_coll_I * dt  &
                      &        * (delta_n_ss * D_s**2 + delta_n_sg * D_s*D_g + delta_n_gg * D_g**2) &
                      &        * (theta_n_ss * v_s**2 - theta_n_sg * v_s*v_g + theta_n_gg * v_g**2)**0.5

                      coll_q = pi/4.0 * q_s * n_g * e_coll_I * dt  &
                      &        * (delta_q_ss * D_s**2 + delta_q_sg * D_s*D_g + delta_q_gg * D_g**2) &
                      &        * (theta_q_ss * v_s**2 - theta_q_sg * v_s*v_g + theta_q_gg * v_g**2)**0.5

!>> ZD_20190830 coll_q replace by coll_n
                      coll_n = MIN(n_s,coll_n) !ZD added from ice particles collecting one another routines
                      coll_q = MIN(q_s,coll_q) !ZD 
...
! << SS_20170728, sylvia
                      ...
                      Ni_sec_gr_br_snow_d(i,j,k) = Ni_sec_gr_br_snow_d(i,j,k) + mult_n
!! << ZD_20190819
        ...
        END SUBROUTINE graupel_breakup_snow
! >> SS_20170317, sylvia
...
!         &                        cmp_fr_qi_d, cmp_fr_qni_d, cmp_hom_qi_d, cmp_hom_qni_d
...
! >> OCH
!                IF (lcmprates) THEN
!                  cmp_hom_qi_d(i,j,k)  = fr_q
!                  cmp_hom_qni_d(i,j,k) = fr_n
!                END IF
!<< OCH
              ELSE                                      
                x_c = MIN(MAX(q_c/(n_c+eps),cloud%x_min),cloud%x_max)    !..mittlere Masse
...
!!$                  j_hom = 1.0d6 * EXP(-7.63-2.996*(T_c+30.0))           !..J in 1/(m3 s) 
                  j_hom = 1.0d6 * 10.0**(-7.63-2.996*(T_c+30.0))           !..J in 1/(m3 s)
                ELSE
!!$                  j_hom = 1.0d6 * EXP(-243.4-14.75*T_c-0.307*T_c**2-0.00287*T_c**3-0.0000102*T_c**4)
                  j_hom = 1.0d6 * 10.0**(-243.4-14.75*T_c-0.307*T_c**2-0.00287*T_c**3-0.0000102*T_c**4)
                ENDIF
! >> OCH
!                IF (lcmprates) THEN
!                  cmp_hom_qi_d(i,j,k)  = j_hom/rho_w * dt * q_c * x_c * facg
!                  cmp_hom_qni_d(i,j,k) = j_hom/rho_w * dt * q_c
!                END IF
!<< OCH
...
!>>OCH
!                 IF (lcmprates) THEN
!                    cmp_fr_qi_d(i,j,k) = j_het/ rho_w * dt* q_c * x_c * facg
!                    cmp_fr_qni_d(i,j,k) = j_het/ rho_w * dt * q_c
!                  END IF
!<<OCH
...
! ub<<
  ...
  SUBROUTINE rain_freeze_gamlook ()
    ...
    USE wolken_konstanten,   ONLY: pmax_DS,mu_DS,Nsh_DS,sigma_DS   ! >> SS_20170307, sylvia
    ...
    DOUBLE PRECISION, PARAMETER :: eps  = 1.d-20
    DOUBLE PRECISION :: wahrschein     ! << SS_20170731, sylvia
...
! >> SS_20170307: ohne Hagelklasse, zusätzlicher Term für Eis-Nummer-Steigerung wegen Gefrieren der Tropfen
! sylvia
!ZD>> include the ice_multiplication switch
!              IF (mult_typ(5:5) .eq. '1') THEN
              IF (ice_multiplication .AND. mult_typ(5:5) .eq. '1') THEN
                  wahrschein = maxProbNorm(T_a)
                  !print*,"prob within rain_freeze_gamlook",wahrschein
                  n_ice(i,j,k) = n_ice(i,j,k)  + fr_n_i*(1 + wahrschein*Nsh_DS)   ! enhanced
                  Ni_secondary(i,j,k) = Ni_secondary(i,j,k) + fr_n_i*(1 + wahrschein*Nsh_DS)
                  Ni_sec_dr_spl_d(i,j,k) = Ni_sec_dr_spl_d(i,j,k) + fr_n_i*(1 + wahrschein*Nsh_DS) !>> ZD 30.10.2019
              ELSE
...
! << SS_20170307
            ...
            ELSE
              ...
              q_ice(i,j,k) = q_ice(i,j,k)  + fr_q_i
! >> SS_20170307: mit Hagelklasse, zusätzlicher Term für
! Eis-Nummer-Steigerung wegen Gefrieren der Tropfen
...
! >> SS_20170731, sylvia, calculate the value of the drop shattering
! PDF with normalization on T â237, 273]
  DOUBLE PRECISION FUNCTION maxProbNorm(temtem)
      USE konstanten
      IMPLICIT NONE

      INTEGER :: ii
      DOUBLE PRECISION, INTENT(IN) :: temtem
      DOUBLE PRECISION :: prefactor, thisdist
      DOUBLE PRECISION, DIMENSION(145) :: T_range,fulldist

      prefactor = 1d0/sqrt(2*pi)/sigma_DS

      ! construct the PDF on the mixed-phase temperature range
      DO ii = 1,145
         T_range(ii) = 237 + (ii - 1)*0.25
      END DO

      fulldist = prefactor * exp(-(T_range - mu_DS)**2/(2 * sigma_DS**2))
      thisdist = prefactor * exp(-(temtem - mu_DS)**2/(2 * sigma_DS**2))
      maxProbNorm = pmax_DS * thisdist / MAXVAL(fulldist)
      !print*,"prob within maxProbNorm",maxProbNorm

  END FUNCTION maxProbNorm
! << SS_20170731, sylvia
...
! << SS_20180921, sylvia
    ...
    USE wolken_konstanten,  ONLY: gfct,pmax_DS,mu_DS,Nsh_DS,sigma_DS   ! >> SS_20170307, sylvia
...
!              IF (mult_typ(5:5) .eq. '1') THEN
               IF (ice_multiplication .AND. mult_typ(5:5) .eq. '1') THEN
                   wahrschein = maxProbNorm(T_a)
                   n_ice(i,j,k) = n_ice(i,j,k) + fr_n_i*(1 + wahrschein*Nsh_DS)
                   Ni_secondary(i,j,k) = Ni_secondary(i,j,k) + fr_n_i*(1 + wahrschein*Nsh_DS)
                   Ni_sec_dr_spl_d(i,j,k) = Ni_sec_dr_spl_d(i,j,k) + fr_n_i*(1 + wahrschein*Nsh_DS) !>> ZD 30.10.2019
               ELSE
                   n_ice(i,j,k) = n_ice(i,j,k)  + fr_n_i
...
! >> OCH
            IF (lcmprates) THEN
              cmp_self_qi_d(i,j,k)  =  self_q
              cmp_self_qni_d(i,j,k) =  self_n
            END IF
! << OCH
  ...
  SUBROUTINE snow_selfcollection()
    ...
    USE globale_variablen,  ONLY: loc_ix, loc_iy, loc_iz, dim_ix, dim_iy, dim_iz, &
                                  T, p, q, &
         &                        q_snow, n_snow, dt, cmp_self_qns_d
    USE konstanten,         ONLY: pi,cv,cp,wolke_typ 
    USE parallele_umgebung, ONLY: isIO
    USE data_runcontrol,    ONLY: lcmprates
...
! ub>> setzte melt_n so, dass x_s beim Schmelzvorgang erhalten bleibt:
  ...
  SUBROUTINE graupel_ice_collection()
    ...
    USE globale_variablen,  ONLY: loc_ix, loc_iy, loc_iz, dim_ix, dim_iy, dim_iz, &
         ...
         &                        cmp_coll_qi_qg_d , cmp_coll_qni_qng_d
    USE konstanten,         ONLY: pi,cv,cp,wolke_typ 
    USE parallele_umgebung, ONLY: isIO
    USE data_runcontrol,    ONLY: lcmprates
...
!>>ZD
            IF (lcmprates) THEN
              cmp_coll_qi_qg_d(i,j,k)   = coll_q
              cmp_coll_qni_qng_d(i,j,k) = coll_n
            END IF
!<<ZD
...
!>>OCH
            IF (lcmprates) THEN
              cmp_coll_qi_qs_d(i,j,k)   = coll_q
              cmp_coll_qni_qns_d(i,j,k) = coll_n
            END IF
!<<OCH
  ...
  SUBROUTINE graupel_selfcollection()
    ...
    USE globale_variablen,  ONLY: loc_ix, loc_iy, loc_iz, dim_ix, dim_iy, dim_iz, &
                                  T, p, q, &
         &                        q_graupel, n_graupel, dt, cmp_self_qng_d
    USE konstanten,         ONLY: pi,cv,cp,wolke_typ 
    USE parallele_umgebung, ONLY: isIO
    USE data_runcontrol,    ONLY: lcmprates
...
!>>OCH
            IF (lcmprates) THEN
              cmp_self_qng_d(i,j,k) = cmp_self_qng_d(i,j,k) + self_n
            END IF
!<<OCH
...
! >> SS_170317, sylvia
!ZD >> IF (mult_typ(1:1) .eq. '1') THEN   !include ice multiplication switch
    IF (ice_multiplication .AND. mult_typ(1:1) .eq. '1') THEN
        CALL hail_breakup_graupel ()
                   !write (*,*) '40Z hail break graupel' !ZD

    ENDIF

!ZD >> IF (mult_typ(2:2) .eq. '1') THEN   !include ice multiplication switch
    IF (ice_multiplication .AND. mult_typ(2:2) .eq. '1') THEN
        CALL graupel_breakup_ice ()
                   !write (*,*) '41Z graupel break ice' !ZD
    ENDIF

!ZD >> IF (mult_typ(3:3) .eq. '1') THEN   !include ice multiplication switch
   IF (ice_multiplication .AND. mult_typ(3:3) .eq. '1') THEN
       CALL hail_breakup_ice ()
                   !write (*,*) '42Z hail break ice' !ZD
   ENDIF

!ZD >> IF (mult_typ(4:4) .eq. '1') THEN   !include ice multiplication switch
   IF (ice_multiplication .AND. mult_typ(4:4) .eq. '1') THEN
       CALL graupel_breakup_snow ()
                   !write (*,*) '43Z grapel break snow' !ZD
...
!         & cmp_fr_qni_d,   cmp_nuc_qi_d,     cmp_nuc_qni_d,    &
!         & cmp_dep_qi_d,   cmp_dep_qc_d,     cmp_dep_qs_d,     &
         & cmp_sub_qi_d,   cmp_sub_qs_d, cmp_sub_qg_d,  cmp_melt_snow_d, cmp_melt_ice_d, &
         & cmp_self_qns_d,   cmp_self_qng_d,   &
!         & cmp_self_qnc_d, cmp_rime_qi_qc_d, cmp_rime_qs_qc_d, &
!         & cmp_rime_qg_qc_d, &
         & cmp_rime_graup_d, &! cmp_coll_qi_qs_d,  &
!         & cmp_coll_qc_qr_d, cmp_coll_qnc_qnr_d,  &
...
!! << SS_20160525
    ...
    IF (firstcall /= 1) THEN
      ...
      ALLOCATE (n_cloud(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           ...
           Ni_primary(0:dim_ix, 1:dim_iy, 1:dim_iz), & !! >> SS_20160525, sylvia
           Ni_secondary(0:dim_ix, 1:dim_iy, 1:dim_iz), &  !! << SS_20160525
           STAT = stat_var)
      IF (stat_var /= 0) THEN
...
!OCH >>
           ALLOCATE (&
!           cmp_nuc_qi_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
!           cmp_nuc_qni_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
!           cmp_act_qc_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
!           cmp_act_qnc_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
!           cmp_fr_qi_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
!           cmp_fr_qni_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_dep_qi_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
!           cmp_dep_qc_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_dep_qs_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_dep_qg_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_sub_qi_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_sub_qs_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_sub_qg_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_self_qi_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_self_qni_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_self_qns_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_self_qng_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
!           cmp_self_qnc_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_rime_qi_qc_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_rime_qs_qc_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_rime_qi_qr_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_rime_qs_qr_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_melt_qs_qr_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_melt_qi_qr_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_melt_snow_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_melt_ice_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_rime_qg_qc_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_rime_qg_qr_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_rime_ice_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_rime_snow_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_rime_graup_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_rime_ice_rain_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_rime_snow_rain_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_rime_graup_rain_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_coll_qi_qs_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_coll_qni_qns_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_coll_qi_qg_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_coll_qni_qng_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
!           cmp_coll_qc_qr_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
!           cmp_coll_qnc_qnr_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_conv_qi_qg_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_conv_qni_qng_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_conv_qs_qg_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_conv_qns_qng_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           cmp_conv_qc_qr_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
!           cmp_conv_qnc_qnr_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
!           cmp_mult_ice_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
!           cmp_mult_snow_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
!           cmp_mult_graup_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
!           cmp_hom_sol_qi_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
!           cmp_hom_sol_qni_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
!           cmp_hom_qi_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
!           cmp_hom_qni_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &
           Ni_sec_gr_br_ice_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &  !! << ZD_20190819
           Ni_sec_gr_br_snow_d(0:dim_ix, 1:dim_iy, 1:dim_iz), & !! << ZD_20190819
           Ni_sec_dr_spl_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &  !! << ZD_20190819 
           Ni_sec_hm_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &  !! << ZD_20190819
           Ni_pri_homhet_d(0:dim_ix, 1:dim_iy, 1:dim_iz), &  !! << ZD_20190819
           STAT = stat_var)
      IF (stat_var /= 0) THEN
        CALL abortparallel ("Fehler bei Allokierung Hydrometeore ", stat_var)
      END IF
...
!! >> ZD_20190819
   Ni_sec_gr_br_ice_d = 0.0
   Ni_sec_gr_br_snow_d = 0.0
   Ni_sec_dr_spl_d = 0.0
   Ni_sec_hm_d = 0.0
   Ni_pri_homhet_d = 0.0
!! << ZD
...
!    cmp_dep_qc_d  = 0.0
    ...
    cmp_self_qng_d  = 0.0
!    cmp_self_qnc_d  = 0.0
    cmp_rime_qi_qc_d  = 0.0
    cmp_rime_qs_qc_d  = 0.0
    cmp_rime_qi_qr_d  = 0.0
    cmp_rime_qs_qr_d  = 0.0
    cmp_melt_qs_qr_d  = 0.0
    cmp_melt_qi_qr_d  = 0.0
    cmp_melt_snow_d  = 0.0
    cmp_melt_ice_d  = 0.0
    cmp_rime_qg_qc_d  = 0.0
    cmp_rime_qg_qr_d  = 0.0
    cmp_rime_ice_d  = 0.0
    cmp_rime_snow_d  = 0.0
    cmp_rime_graup_d  = 0.0
    cmp_rime_ice_rain_d  = 0.0
    cmp_rime_snow_rain_d  = 0.0
    cmp_rime_graup_rain_d  = 0.0
    cmp_coll_qi_qs_d  = 0.0
    cmp_coll_qni_qns_d  = 0.0
    cmp_coll_qi_qg_d = 0.0
    cmp_coll_qni_qng_d = 0.0
!    cmp_coll_qc_qr_d  = 0.0
!    cmp_coll_qnc_qnr_d  = 0.0
    cmp_conv_qi_qg_d  = 0.0
    cmp_conv_qni_qng_d  = 0.0
    cmp_conv_qs_qg_d  = 0.0
    cmp_conv_qns_qng_d  = 0.0
    cmp_conv_qc_qr_d  = 0.0
!    cmp_conv_qnc_qnr_d  = 0.0
!    cmp_mult_ice_d  = 0.0
!    cmp_mult_snow_d  = 0.0
!    cmp_mult_graup_d  = 0.0
!    cmp_hom_sol_qi_d  = 0.0
!    cmp_hom_sol_qni_d  = 0.0
!    cmp_hom_qi_d  = 0.0
!    cmp_hom_qni_d  = 0.0
END IF
!OCH<<
  ...
  SUBROUTINE dealloc_wolken ()
    ...
    USE globale_variablen,  ONLY: q_cloud, q_rain, q_ice, q_snow, q_graupel,  &
       ...
       & cmp_dep_qi_d,   cmp_dep_qs_d,  cmp_dep_qg_d,   cmp_self_qi_d,&
       & cmp_self_qni_d, cmp_rime_qi_qc_d, cmp_rime_qs_qc_d, cmp_rime_qg_qc_d,   &
       & cmp_rime_qi_qr_d, cmp_rime_qs_qr_d, cmp_rime_qg_qr_d, cmp_melt_qi_qr_d, cmp_melt_qs_qr_d, &
       & cmp_rime_ice_d, cmp_rime_snow_d, cmp_coll_qi_qs_d, cmp_coll_qi_qg_d, cmp_conv_qc_qr_d,&
        & cmp_rime_ice_rain_d, cmp_rime_snow_rain_d, cmp_rime_graup_rain_d, &
!         & cmp_act_qc_d,   cmp_act_qnc_d,    cmp_fr_qi_d,      &
!         & cmp_fr_qni_d,   cmp_nuc_qi_d,     cmp_nuc_qni_d,    &
!         & cmp_dep_qi_d,   cmp_dep_qc_d,     cmp_dep_qs_d,     &
         & cmp_sub_qi_d,   cmp_sub_qs_d, cmp_sub_qg_d,  cmp_melt_ice_d, cmp_melt_snow_d, &
         & cmp_self_qns_d,   cmp_self_qng_d,   &
!         & cmp_self_qnc_d, cmp_rime_qi_qc_d, cmp_rime_qs_qc_d, &
!         & cmp_rime_qg_qc_d, &
         & cmp_rime_graup_d, & !cmp_coll_qi_qs_d,  &
...
#endif
!OCH>>
      DEALLOCATE( cmp_dep_qi_d,   cmp_dep_qs_d,  cmp_dep_qg_d,   cmp_self_qi_d,&
       & cmp_self_qni_d, cmp_rime_qi_qc_d, cmp_rime_qs_qc_d, cmp_rime_qg_qc_d,   &
       & cmp_rime_qi_qr_d, cmp_rime_qs_qr_d, cmp_rime_qg_qr_d, cmp_melt_qi_qr_d, cmp_melt_qs_qr_d, &
       & cmp_rime_ice_d, cmp_rime_snow_d, cmp_coll_qi_qs_d, cmp_coll_qi_qg_d, cmp_conv_qc_qr_d, &
       & cmp_rime_ice_rain_d, cmp_rime_snow_rain_d, cmp_rime_graup_rain_d, &
...
!         & cmp_coll_qc_qr_d, cmp_coll_qnc_qnr_d,  &
         & cmp_coll_qni_qns_d, cmp_coll_qni_qng_d, cmp_conv_qni_qng_d , &
         & cmp_conv_qi_qg_d, cmp_conv_qs_qg_d, &
         & cmp_conv_qns_qng_d, Ni_sec_gr_br_ice_d, Ni_sec_gr_br_snow_d, Ni_sec_dr_spl_d, Ni_sec_hm_d, Ni_pri_homhet_d) !, cmp_conv_qc_qr_d,               &
!         & cmp_conv_qnc_qnr_d, cmp_mult_ice_d, cmp_mult_snow_d,    &
!         & cmp_mult_graup_d, cmp_hom_sol_qi_d, cmp_hom_sol_qni_d,  &
!         & cmp_hom_qi_d)
!OCH<<
...
!         cmp_conv_qnc_qnr_d, cmp_self_qnc_d,
         cmp_conv_qc_qr_d
...
!>> OCH
    IF (lcmprates) THEN
!      cmp_conv_qnc_qnr_d = rate_nr !autoconversion
      cmp_conv_qc_qr_d = rate_q
!      cmp_self_qnc_d = rate_nc -rate_nr ! selfcollection without autoconversion
    END IF
!<< OCH
    ! ub>>
#ifdef SAVE_CONVERSIONRATES
  ...
  SUBROUTINE accretionSB ()
    ...
    USE globale_variablen,  ONLY: loc_ix, loc_iy, loc_iz, dim_ix, dim_iy, dim_iz, dt, &
         ...
         &                        speichere_dqdt!, cmp_coll_qc_qr_d, cmp_coll_qnc_qnr_d
    USE konstanten,         ONLY: pi
    USE parallele_umgebung, ONLY: isIO,abortparallel
    USE data_runcontrol,    ONLY: lcmprates
...
! >> OCH
!    IF (lcmprates) THEN
!      cmp_coll_qc_qr_d = rate_q
!      cmp_coll_qnc_qnr_d = rate_n
!    END IF
! << OCH
    ! ub>>
#ifdef SAVE_CONVERSIONRATES
  ...
  SUBROUTINE autoconversionKB ()
    ...
    USE konstanten,         ONLY: pi
    USE parallele_umgebung, ONLY: isIO,abortparallel
    USE globale_variablen,  ONLY: dqdt, speichere_dqdt!, cmp_conv_qc_qr_d, cmp_conv_qnc_qnr_d, cmp_self_qnc_d
...
!OCH>>
!    IF (lcmprates) THEN
!       cmp_conv_qnc_qnr_d = rate_n !autoconversion
!       cmp_conv_qc_qr_d = rate_q
!    END IF
!OCH<<
    ! ub>>
  ...
  SUBROUTINE accretionKB ()
    ...
    USE konstanten,         ONLY: pi
    USE parallele_umgebung, ONLY: isIO,abortparallel
    USE globale_variablen,  ONLY: dqdt, speichere_dqdt!, cmp_coll_qc_qr_d, cmp_coll_qnc_qnr_d
...
! << OCH
  ...
  SUBROUTINE vapor_deposition_growth(dt_local,i_local)
    ...
    USE globale_variablen,  ONLY: loc_ix, loc_iy, loc_iz, dim_ix, dim_iy, dim_iz, T, p, q, rho, &
         ...
         &                        deprate_ice, deprate_snow, cmp_dep_qi_d, cmp_dep_qs_d, cmp_dep_qg_d, &
         &                        cmp_sub_qi_d, cmp_sub_qs_d, cmp_sub_qg_d
...
!>>OCH
            IF (lcmprates) THEN
              IF (dep_ice(i,j,k) + dep_graupel(i,j,k) + dep_snow(i,j,k) + dep_hail(i,j,k) >= 0.0) THEN
                cmp_dep_qi_d(i,j,k) = cmp_dep_qi_d(i,j,k) + dep_ice(i,j,k)
                cmp_dep_qs_d(i,j,k) = cmp_dep_qs_d(i,j,k) + dep_snow(i,j,k)
                cmp_dep_qg_d(i,j,k) = cmp_dep_qg_d(i,j,k) + dep_graupel(i,j,k)
              ELSE
                cmp_sub_qi_d(i,j,k) = cmp_sub_qi_d(i,j,k) + dep_ice(i,j,k)
                cmp_sub_qs_d(i,j,k) = cmp_sub_qs_d(i,j,k) + dep_snow(i,j,k)
                cmp_sub_qg_d(i,j,k) = cmp_sub_qg_d(i,j,k) + dep_graupel(i,j,k) !>>ZD
              END IF
            END IF
!<<OCH
...
!>>OCH
            IF (lcmprates) THEN
              ...
              ELSE
                cmp_sub_qi_d(i,j,k) = cmp_sub_qi_d(i,j,k) + dep_ice(i,j,k)
                cmp_sub_qs_d(i,j,k) = cmp_sub_qs_d(i,j,k) + dep_snow(i,j,k)
                cmp_sub_qg_d(i,j,k) = cmp_sub_qg_d(i,j,k) + dep_graupel(i,j,k)
              END IF
            END IF
!<<OCH
...
!!$ UB_20120914              f_v  = max(f_v,1.d0) !unnoetig??
  ...
  SUBROUTINE cloud_nucleation()
    ...
    USE globale_variablen,  ONLY: loc_ix, loc_iy, loc_iz, dim_ix, dim_iy, dim_iz, &
         ...
         &                        dqdt, speichere_dqdt, cond_neu_sb,     &
         &                        evap_neu_sb, speichere_precipstat!,cmp_act_qc_d, cmp_act_qnc_d
...
!>>OCH
!          IF (lcmprates) THEN
!            cmp_act_qc_d(i,j,k)  = nuc_q
!            cmp_act_qnc_d(i,j,k) = nuc_n
!          END IF
!<<OCH
