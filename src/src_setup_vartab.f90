...
!  Added TTENS_DIAB, the correct total pure diabatic temperature tendency
!  Added LPI, the Lightning Potential Index
! V5_4b        2016-07-12 Xavier Lapillonne
!  Added fields ttdiab_conv, dqvdt_conv
!
! Code Description:
! Language: Fortran 90.
...
! ---------------------------------------------------------------
    ...
    ttens_diab  ,   & ! temperature tendency due to pure diabatic processes (  K/s  )
...
USE data_fields,        ONLY:                              &
    ...
    dqvdt_conv ,    & ! 3d convective moisure convergence             ( 1/s  )
...
!OCH>>
    ...
    cmp_melt_snow   , & ! melting of snow to rain
    cmp_melt_ice    , & ! melting of ice to rain
    cmp_rime_qg_qc  , & ! riming on graupel particles
    cmp_rime_qg_qr  , & ! riming on graupel particles with rain
    ...
    cmp_rime_ice_rain    , & ! rain droplet reduction due to riming on ice
    cmp_rime_snow_rain   , & ! rain droplet reduction due to riming on snow
    cmp_rime_graup_rain  , & ! rain droplet reduction due to riming on graupel
    cmp_coll_qi_qs  , &
    cmp_coll_qi_qg  , &
    cmp_coll_qni_qng  , &
...
var(1, 57,2)= ar_des('DQVDT_CONV',   110,  0,  0,   1.0_wp    , 0.0_wp,   0,   3,  ke,     dum4,  dum4, dqvdt_conv,  dum3,dum2, 1,&
      's-1         ','tendency_of_specific_humidity_due_to_convection',  'convective tendency of water vapor',                 ' ')
...
var(1, 90,2)= ar_des('TTDIAB_CONV',  110,  0,  0,   1.0_wp    , 0.0_wp,   0,   3,  ke,     dum4,  dum4,ttdiab_conv,  dum3,dum2, 1,&
      'K s-1       ','tendency_of_pure_diabatic_temp_due_to_convection','convective tendency of diabatic temperature', ' ')
...
#ifdef TWOMOM_SB
var(1,103,2)= ar_des('TAU_I_SO',     110,  0,  0,   1.0_wp    , 0.0_wp,   0, 3,    ke,     dum4,  dum4,  odepthi_so,   dum3, dum2, 1,&
      '1     ','optical_depth_cloud_ice',                    'optical depth of cloud ice',            ' ')
var(1,104,2)= ar_des('TAU_I_TH',     110,  0,  0,   1.0_wp    , 0.0_wp,   0, 3,    ke,     dum4,  dum4,  odepthi_th,   dum3, dum2, 1,&
      '1     ','optical_depth_cloud_ice',                    'optical depth of cloud ice',            ' ')
var(1,105,2)= ar_des('TAU_C_SO',     110,  0,  0,   1.0_wp    , 0.0_wp,   0, 3,    ke,     dum4,  dum4,  odepthw_so,   dum3, dum2, 1,&
      '1     ','optical_depth_cloud_water',                    'optical depth of cloud water',            ' ')
var(1,106,2)= ar_des('TAU_C_TH',     110,  0,  0,   1.0_wp    , 0.0_wp,   0, 3,    ke,     dum4,  dum4,  odepthw_th,   dum3, dum2, 1,&
      '1     ','optical_depth_cloud_water',                    'optical depth of cloud water',            ' ')
#endif
...
!!$ LPI_BUO is only for testing purposes, not an official grib field:
!var(1,138,2)= ar_des('LPI_BUO ',   1,  0,  0,   1.0_wp    , 0.0_wp,   0,   2,  -1,     dum4,  dum4,  dum3,   dum3,    dum2, 0,&
!      'J kg-2','buo_lightning_potential_index'                ,      'Buo in Lightning Potential Index',             ' ')
...
var(1,158,2)= ar_des('TKHM      ',   109,  0,  0,   1.0_wp    , 0.0_wp,   0,   3,  ke1,    dum4,  dum4,  tkhm,   dum3,    dum2, 1,&
      'm2 s-1      ','atmosphere_horiz_momentum_diffusivity',                'horizontal diffusion coefficient of momentum',        ' ')
var(1,159,2)= ar_des('TKHH      ',   109,  0,  0,   1.0_wp    , 0.0_wp,   0,   3,  ke1,    dum4,  dum4,  tkhh,   dum3,    dum2, 1,&
...
var(1,196,2)= ar_des('LPI       ',     1,  0,  0,   1.0_wp    , 0.0_wp,   0,   2,  -1,     dum4,  dum4,  dum3,   dum3,    dum2, 0,&
      'J kg-2','lightning_potential_index'                    ,'Lightning Potential Index',                         ' ')
...
var(1,230,2)= ar_des('DBZ       ',   110,  0,  0,   1.0_wp    , 0.0_wp,   0,   3,  -1,     dum4,  dum4,  dum3,   dum3,    dum2, 0,& 
      '1           ','-',                         'unattenuated radar reflectivity in Rayleigh approximation',      ' ')
var(2,230,2)= ar_des('DBZ_850   ',     1,  0,  0,   1.0_wp    , 0.0_wp,   0,   2,  -1,     dum4,  dum4,  dum3,   dum3,    dum2, 0,& 
      '1           ','-',              'unattenuated radar reflectivity in Rayleigh approximation in 850 hPa',      ' ')
var(3,230,2)= ar_des('DBZ_CMAX  ',   200,  0,  0,   1.0_wp    , 0.0_wp,   0,   2,  -1,     dum4,  dum4,  dum3,   dum3,    dum2, 0,& 
      '1           ','-',         'unattenuated radar reflectivity in Rayleigh approximation: column maximum',      ' ')
...
#ifdef TWOMOM_SB
var(1,252,2)= ar_des('REFF_C    ',   110,  0,  0,   1.0_wp    , 0.0_wp,   0, 3,    ke,     dum4,  dum4, reffc_out,   dum3,    dum2, 1,&
      'm     ','reff_cloud     ',     'effective radius of cloud droplets',                                             ' ')
var(1,253,2)= ar_des('REFF_I    ',   110,  0,  0,   1.0_wp    , 0.0_wp,   0, 3,    ke,     dum4,  dum4, reffi_out,   dum3,    dum2, 1,&
...
var(1, 33,3)= ar_des('TTENS_DIAB',   110,  0,  0,   1.0_wp    , 0.0_wp,   0,   3,  ke,     dum4,  dum4, ttens_diab, dum3, dum2, 1,&
      'K           ','-',                           'temperature tendency due to pure diabatic processes',          ' ')
...
var(1,  64,12)= ar_des('RIME_QG_QC  ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    cmp_rime_qg_qc,  dum3,    dum2, 1,&
      'kg m-3'  ,  'riming of qc on qg',                           'Riming on graupel particles with cloud drops',    ' ')
...
var(1,  68,12)= ar_des('COLL_QS_QI  ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    cmp_coll_qi_qs,  dum3,    dum2, 1,&
      'kg m-3'  ,  'coll of qi by qs',                           'collection of cloud ice by snow',    ' ')
var(1,  69,12)= ar_des('COLL_QNS_QNI  ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    cmp_coll_qni_qns,  dum3,    dum2, 1,&
...
var(1,  91,12)= ar_des('RIME_QI_QR  ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    cmp_rime_qi_qr,  dum3,    dum2, 1,&
      'kg m-3'  ,  'riming of qr on qi',                           'Riming on ice particles with rain',    ' ')
var(1,  92,12)= ar_des('RIME_QS_QR  ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    cmp_rime_qs_qr,  dum3,    dum2, 1,&
      'kg m-3'  ,  'riming of qr on qs',                           'Riming on snow particles with rain',    ' ')
var(1,  93,12)= ar_des('MELT_QI_QR  ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    cmp_melt_qi_qr,  dum3,    dum2, 1,&
      'kg m-3'  ,  'melting of qi to qr',                           'Melting of ice to rain',    ' ')
var(1,  94,12)= ar_des('MELT_QS_QR  ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    cmp_melt_qs_qr,  dum3,    dum2, 1,&
...
var(1,  103,12)= ar_des('RIME_QG_QR  ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    cmp_rime_qg_qr,  dum3,    dum2, 1,&
      'kg m-3'  ,  'riming of qr on qg',                           'Riming on graupel particles with rain',    ' ')
var(1,  104,12)= ar_des('RIME_ICE_R  ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    cmp_rime_ice_rain,  dum3,    dum2, 1,&
      'm-3'  ,  'dqn due to riming on qi',                           'Rain number loss due to riming on ice',    ' ')
var(1,  105,12)= ar_des('RIME_SNOW_R  ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    cmp_rime_snow_rain,  dum3,    dum2, 1,&
      'm-3'  ,  'dqn due to riming on qs',                           'Rain number loss due to riming on snow',    ' ')
var(1,  106,12)= ar_des('RIME_GR_R  ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    cmp_rime_graup_rain,  dum3,    dum2, 1,&
      'm-3'  ,  'dqn due to riming on qg',                           'Rain number loss due to riming on graupel',    ' ')
var(1,  109,12)= ar_des('QG_SUB     ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,     cmp_sub_qg,   dum3,    dum2, 1,&
      'kg m-3'  ,  'sub of qg',                           'sublimation of graupel',                                ' ')
var(1,  110,12)= ar_des('QG_DEP     ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,     cmp_dep_qg,   dum3,    dum2, 1,&
      'kg m-3'  ,  'depositional growth of qg',                           'depositional growth of graupel',                          ' ')
var(1,  114,12)= ar_des('COLL_QG_QI  ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    cmp_coll_qi_qg,  dum3,    dum2, 1,&
      'kg m-3'  ,  'coll of qi by qg',                           'collection of cloud ice by graupel',    ' ')
var(1,  115,12)= ar_des('COLL_QNG_QNI  ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    cmp_coll_qni_qng,  dum3,    dum2, 1,&
      'm-3'  ,  'coll of qni by qng',                           'collection of cloud ice by graupel',    ' ')
var(1,  116,12)= ar_des('MELT_ICE  ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    cmp_melt_ice,  dum3,    dum2, 1,&
      'm-3'  ,  'melting of qni to qnr',                           'Melting of ice number to rain',    ' ')
var(1,  117,12)= ar_des('MELT_SNOW  ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    cmp_melt_snow,  dum3,    dum2, 1,&
      'm-3'  ,  'melting of qns to qnr',                           'Melting of snow number to rain',    ' ')

END IF
!<<OCH
var(1,  107,12)= ar_des('MULT_BR_GI  ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    Ni_sec_gr_br_ice,  dum3,    dum2, 1,&
      'm-3'  ,  'Ice generated due to graupel breaking ice',                           'Ice increase due to graupel ice collisions',    ' ')
var(1,  108,12)= ar_des('MULT_BR_GS  ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    Ni_sec_gr_br_snow,  dum3,    dum2, 1,&
      'm-3'  ,  'Ice generated due to graupel breaking snow',                           'Ice increase due to graupel snow collisions',    ' ')
var(1,  111,12)= ar_des('MULT_DS  ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    Ni_sec_dr_spl,  dum3,    dum2, 1,&
      'm-3'  ,  'Ice generated due to fr dr splint',                            'Ice increase due to frozen droplet splintering',    ' ')
var(1,  112,12)= ar_des('MULT_HM ',     110,     0,     0,   1.0    , 0.0,   0,   3, ke, dum4,  dum4,    Ni_sec_hm,  dum3,    dum2, 1,&
...
IF (lcheck_alloc) THEN
  ...
  IF (.NOT. ALLOCATED(ttdiab_conv)) var(1,244,2)%idef_stat = -1
  IF (.NOT. ALLOCATED(dqvdt_conv)) var(1,245,2)%idef_stat = -1

  IF (.NOT. ALLOCATED(tinc_lh  ))  var(1, 32,3)%idef_stat = -1
  IF (.NOT. ALLOCATED(ttens_diab)) var(1, 33,3)%idef_stat = -1
