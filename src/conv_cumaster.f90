...
!  USE yomhook   ,ONLY : lhook,   dr_hook
  ...
  USE conv_adjust,      ONLY: satur
  USE conv_cufunctions, ONLY: foelhmcu, foealfa
  USE conv_cuinit,      ONLY: cuinin, cubasen
  USE conv_cuascn,      ONLY: cuascn
  USE conv_cudescn,     ONLY: cudlfsn, cuddrafn
  USE conv_cuflxtends,  ONLY: cuflxn, cudtdqn, cududv, cuctracer
